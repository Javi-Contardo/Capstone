...
<head>
    ...
    <script>
        $(document).ready(function() 
            {
                ...
                $("#titulo-cabecera").append($("<a href='carga_archivos_stock.php' class='text-success'><i class='fa-duotone fa-solid fa-arrow-right fa-rotate-90' style=''--fa-secondary-color: #ffffff;'></i> Atras</a>"));
        ...
        function sube_archivo(input) 
        	{
            $.post("carga_archivos_stock_progreso_cancelar.php",{limpiar_sesion:'OK'})
            ...
            reader.onload = function (e) 
                {
                  ...
                  $.ajax({
                      type: 'POST',
                      url: 'carga_archivos_stock_ajax.php',
                      data: formData,
                      processData: false,
                      contentType: false,
                      xhr: function(){
        ...
        function procesa_archivo(nombre_archivo)
            ...
            function() 
                {
                $.ajax({url: 'carga_archivos_stock_progreso.php',
            ...
            $.post("carga_archivos_stock_ajax.php",{nombre_archivo:nombre_archivo,area:'PROCESA_ARCHIVO'},
            function(result) 
                {
		...
		function procesa_archivo_big(nombre_archivo,registro)
            ...
            $.post("carga_archivos_stock_ajax.php",{nombre_archivo:nombre_archivo,registro:registro,area:'PROCESA_ARCHIVO'},
            function(result) 
                {
                console.log("###3"+result+"#####");
                var obj = JSON.parse(result);
