const pages = [
    ...
    {
        output: './management-dashboard.html',
        content: {
            title: 'Management',
            description: 'This is an example dashboard created using build-in elements and components.',
        },
        template: './src/DemoPages/dashboards/management-dashboard.hbs'
    },
    {
        output: './advertisement-dashboard.html',
        content: {
            title: 'Advertisement',
            description: 'This is an example dashboard created using build-in elements and components.',
        },
        template: './src/DemoPages/dashboards/advertisement-dashboard.hbs'
    },
    {
        output: './helpdesk-dashboard.html',
        content: {
            title: 'Helpdesk',
            description: 'This is an example dashboard created using build-in elements and components.',
        },
        template: './src/DemoPages/dashboards/helpdesk-dashboard.hbs'
    },
    {
        output: './pm-dashboard.html',
        content: {
            title: 'Project Management',
            description: 'This is an example dashboard created using build-in elements and components.',
        },
        template: './src/DemoPages/dashboards/pm-dashboard.hbs'
    },
    {
        ...
        template: './src/DemoPages/dashboards/monitoring-dashboard.hbs'
    },
    {
        output: './crypto-dashboard.html',
        content: {
            title: 'Cryptocurrency',
            description: 'This is an example dashboard created using build-in elements and components.',
        },
        template: './src/DemoPages/dashboards/crypto-dashboard.hbs'
    },
    {
        output: './product-dashboard.html',
        content: {
            title: 'Product Sales',
            description: 'This is an example dashboard created using build-in elements and components.',
        },
        template: './src/DemoPages/dashboards/product-dashboard.hbs'
    },
    {
        output: './statistics-dashboard.html',
        content: {
            title: 'Statistics Panel',
            description: 'This is an example dashboard created using build-in elements and components.',
        },
        template: './src/DemoPages/dashboards/statistics-dashboard.hbs'
    },
...

    {
        ...
        content: {
            title: 'Login',
            description: 'Kero HTML Bootstrap 5 Dashboard Template',
            heading_icon: ''
        },
    ...
    },
    {
        ...
        content: {
            title: 'Pills Buttons',
            description: 'The pills buttons from Kero Dashboard have 100% rounded corners.',
    ...
    },
    {
        ...
        content: {
            title: 'Dropdowns',
            description: 'Multiple styles, actions and effects are available for the Archited Dashboard dropdown buttons.',
    ...
    },
    {
        ...
        content: {
            title: 'Count Up',
            description: 'Add animations to your numbers. It\'ll make your next Kero app more user friendly.',
    ...
    },
    {
        ...
        content: {
            title: 'Grid Tables',
            description: 'Basic example of a Bootstrap 5 table with sort, search and filter functionality.',
            heading_icon: 'pe-7s-notebook icon-gradient bg-mixed-hopes'
        },
    ...
    },
    {
        ...
        content: {
            title: 'Form Layouts',
            description: 'Build whatever layout you need with our Kero Dashboard.',
    ...
    },
    {
        ...
        content: {
            ...
            description: 'Inline validation is very easy to implement using the Kero Dashboard.',
