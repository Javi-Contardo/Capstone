...
gulp.task('sass', function () {
    ...
    .pipe(gulp.dest('kero-html-sidebar-pro-demo/assets/css'))
    .pipe(cleanCSS())
...
gulp.task('html', function () {
    ...
    .pipe(gulp.dest('kero-html-sidebar-pro-demo/example-html-pages'));
});

// Concat and uglify JavaScript files
gulp.task('concat', function () {
    return gulp.src('src/js/**/*.js')
    .pipe(gulp.dest('kero-html-sidebar-pro-demo/assets/js'));
});
...
gulp.task('images', function() {
    ...
    .pipe(gulp.dest('kero-html-sidebar-pro-demo/assets/images'));
});

// Copy Fonts
gulp.task('fonts', function() {
    return gulp.src('src/assets/fonts/**/*.*')
    .pipe(gulpCopy('kero-html-sidebar-pro-demo/', {prefix: 1}))
});

gulp.task('compress', function () {
    gulp.src('kero-html-sidebar-pro-demo/assets/js/**/*.js')
    .pipe(uglify())
    .pipe(rename({ suffix: '.min' }))
    .pipe(gulp.dest('kero-html-sidebar-pro-demo/assets/js'))
});
