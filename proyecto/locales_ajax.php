...
if ($proceso=='DESACTIVAR_LOCAL')
	{
	$id=$_POST['id'];
	$mysqli->query("update locales set estado='SUSPENDIDO' where id='$id'");
	$respuesta='OK';
...
if ($proceso=='ACTIVAR_LOCAL')
	{
	$id=$_POST['id'];
	$mysqli->query("update locales set estado='ACTIVO' where id='$id'");
	$respuesta='OK';
	$datos = array('respuesta' => $respuesta);
	echo json_encode($datos);	
	}
